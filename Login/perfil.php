    ...
    <div id="recuadro">
        ...
        <div id="panel-libre">
            ...
            <style>
                ...
                /* ============================================
                   EFECTO HOVER PARA RECÓADROS DE LA IZQUIERDA
                   ============================================ */
                
                /* 1. Preparamos el recuadro para que la animación sea suave */
                .panel-izquierda .panel-box {
                    transition: transform 0.3s ease, box-shadow 0.3s ease;
                    position: relative; /* Para evitar que se corte al crecer */
                }

                /* 2. El efecto al pasar el ratón */
                .panel-izquierda .panel-box:hover {
                    transform: scale(1.03); /* Hace que crezca un 3% */
                    box-shadow: 0 12px 25px rgba(0, 0, 0, 0.15); /* Sombra más fuerte y flotante */
                    z-index: 10; /* Lo superpone sobre los demás recuadros */
                    border: 1px solid #1a3d7c; /* Le pone un bordecito azul sutil al hacer hover */
                }
            </style>
